...
詳細な受入手順は [docs/features/auth-client.md](../docs/features/auth-client.md) を参照してください。ローカルのGo APIを起動してiPhone実機のExpo Goから確認する一連の順序は [docs/human/local-dev-runbook.md](../docs/human/local-dev-runbook.md) にまとめています。
